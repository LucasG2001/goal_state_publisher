...
public:
    ...
    //methods
    void move(std::vector<double> position, std::vector<double> orientation, ros::Publisher* goal_pose_publisher, double tol = 0.04); // equilibrium pose movement
    ...
    void grasp_object(double speed=0.1, double width=0.0, double force=25, double tol=0.08);
